...
function XAudioServer(channels, sampleRate, minBufferSize, maxBufferSize, underRunCallback, heartbeatCallback, postheartbeatCallback, volume, failureCallback, userEventLatch) {
	...
	this.failureCallback = (typeof failureCallback == "function") ? failureCallback : function () { console.warn("XAudioJS has encountered a fatal error - continuing without sound."); };
...
XAudioServer.prototype.setupWebAudio = function () {
	// Don't close or recreate if we already have a working AudioContext
